...
Two deployment options are available for this platform. The first is a production ready solution for periodic updates which uses Docker-Compose along with Celery, Redis and Nginx. This option enables any developer of researcher to build a fully functioning website by just developing the initial web applica
